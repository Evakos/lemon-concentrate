 ...
 * @return void
 */
function lemon_concentrate_register_block_variation() {
	wp_enqueue_script(
		'lemon-concentrate-block-variations',
...
add_action( 'enqueue_block_assets', 'lemon_concentrate_register_block_variation' );
