 ...
 * @return void
 */
function lemon_concentrate_register_block_patterns() {
	...
	register_block_pattern_category(
		'theme',
		array( 'label' => esc_html__( 'Theme patterns', 'lemon-concentrate' ) )
	);

}
add_action( 'init', 'lemon_concentrate_register_block_patterns', 9 );
 ...
 * @return void
 */
function lemon_concentrate_unregister_patterns() {
